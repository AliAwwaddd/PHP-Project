        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (event) {
                var totalCredits = parseInt(document.getElementById('totalCredits').innerText);
            ...
            function updateTotalCredits() {
                ...
                if (nbCheckedBoxes == nbOfBoxes - numberOfLinkedCourses || nbCheckedBoxes == nbOfBoxes) {
                    ...
                    for (var i = 0; i < checkboxes.length; i++) {
                        if (checkboxes[i].checked) {
                            ...
                            if (flag) flag--;
                            if ((totalCredits + parseInt(checkboxes[i].getAttribute('data-credits'))) <= 36)
