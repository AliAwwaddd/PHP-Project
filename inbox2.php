...
<link rel="stylesheet" href="./CSS Files/inbox2.css">
...
$query = "SELECT * FROM Messages WHERE (is_read = '0' AND type = '0') OR (type = '1' AND is_read = '1')";
...
while ($row = $result->fetch_assoc()) {
    ...
    // Reply form
    echo "<form action='inbox2_reply_process.php' method='post'>";
    ...
    // Calculate the minimum height dynamically based on the number of messages
}
