    ...
    <div class="wrapper">
        <nav>
            ...
            <div class="sidebar-links">
                <ul>
                    <li>
                        <a href="#AddSecretariat" onclick="loadContent('addSecretariat.php')" title="addSecretariat" class="tooltip"
                            id="dashboard-link">
                            <img src="assets/ASe.png" alt="Dashboard">
                            <span class="link hide">add Secretariat</span>
                            <span class="tooltip__content">add Secretariat</span>
                        </a>
                    </li>
                    <li>
                        <a href="#RemoveSecretariat" onclick="loadContent('removeSecretariat.php')" title="RemoveSecretariat" class="tooltip">
                            <img src="assets/RS.png" alt="Analytics">
                            <span class="link hide">RemoveSecretariat</span>
                            <span class="tooltip__content">RemoveSecretariat</span>
                        </a>
                    </li>
                    <li>
                        <a href="#updateMarks" onclick="loadContent('addMarks2.php')" title="UpdateMarks" class="tooltip">
                            <img src="assets/marking.png" alt="marks">
                            <span class="link hide">Update Marks</span>
                            <span class="tooltip__content">Update Marks</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#Inbox" onclick="loadContent('inbox3.php')" title="Inbox" class="tooltip">
            ...
            <div class="sidebar-bottom">
                <div class="sidebar-links">
                    <ul>
                        ...
                        <li>
                            <a href="#settings" onclick="loadContent('page5.3.php')" title="Settings" class="tooltip">
